...
public class Projectile : MonoBehaviour
{
    ...
    public void Initialize(Vector3 _initialMovementDirection, float _initialForceStraength, int _thrownByPlayer)
    {
        initialForce = _initialMovementDirection * _initialForceStraength;
